 ...
 *
 * DOM rendering tests (mounting, clicking Reload, expanding <details>) require
 * @testing-library/react + jsdom which are not in the project's devDependencies.
 * Add them in a follow-up if DOM coverage is needed.
 */
