 ...
 *
 * Layout (top → bottom):
 *   Branded header  — "OHNAR" wordmark left, businessName right
 ...
 *   Footer          — page numbers + "Generated by OHNAR · jobprofit.co.uk"
 *                     Non-Pro adds "Sent with OHNAR" to the footer.
 *
 * Out of scope v1:
 ...
 * @param {boolean}  [opts.isPro]      — controls "Sent with OHNAR" footer line
...
export async function buildPdfFromRows(rows, { title = 'Export', businessName = '', isPro = true, accountFields = null } = {}) {
  ...
  const BLACK = [30, 58, 95];    // #1E3A5F visible-navy — primary text ink
