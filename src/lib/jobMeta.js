...
const META_FIELDS = [
  ...
  // Capture Layer — Slice A. Auto-logged customer touches (call/whatsapp/sms
  // tapped, review link sent) so every contact shows up on the Customer
  // Timeline (customerTimeline.js) without the trader typing a note. Array of
