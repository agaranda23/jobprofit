      ...
      <div className="screen settings-screen" ref={screenRef}>
        ...
        <SectionCard title="FAQ">
          ...
          <FaqItem question="Does OHNAR help me chase late payers?">
            <p>Yes. When a job goes overdue, OHNAR shows a chase prompt. Tap it and a tiered WhatsApp message opens — pre-written for the number of days overdue — ready for you to review and send. The message gets firmer as the debt ages (light nudge at 1–6 days, firm at 7–13 days, final at 14+ days). On Pro, OHNAR can also send you a daily push reminder for each overdue job so none slip through — turn Auto-chase reminders on or off in Settings &rarr; Notifications. The WhatsApp message itself is never sent without you reviewing it and tapping send.</p>
          </FaqItem>
          <FaqItem question="How does the free trial work? What happens after 14 days?">
            <p>You get 14 days of Pro free — no card required to start. After that, you drop to the free tier: the full Get Paid loop (quotes, invoices, receipts) stays unlimited forever, and your documents carry a &ldquo;Sent with OHNAR&rdquo; footer. Upgrade to Pro for £12/mo at any time from Settings &rarr; Subscription to remove the footer, unlock the Insight Layer, and get automated overdue reminders.</p>
          </FaqItem>
